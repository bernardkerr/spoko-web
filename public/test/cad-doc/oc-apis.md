...
| BRepBuilderAPI_MakeEdge | Creates edges from curves, points, vertices, or geometric primitives with various parameter combinations | | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge | https://dev.opencascade.org/doc/refman/html/class_b_rep_builder_a_p_i___make_edge.html |
| BRepBuilderAPI_MakeEdge_1 | Default constructor - requires initialization with Init method | BRepBuilderAPI_MakeEdge_1() | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_1 | - |
| BRepBuilderAPI_MakeEdge_2 | Constructor from vertex to vertex | BRepBuilderAPI_MakeEdge_2(V1: TopoDS_Vertex, V2: TopoDS_Vertex) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_2 | - |
| BRepBuilderAPI_MakeEdge_3 | Constructor from two points | BRepBuilderAPI_MakeEdge_3(P1: gp_Pnt, P2: gp_Pnt) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_3 | - |
| BRepBuilderAPI_MakeEdge_4 | Constructor from line | BRepBuilderAPI_MakeEdge_4(L: gp_Lin) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_4 | - |
| BRepBuilderAPI_MakeEdge_5 | Constructor from line with parameter bounds | BRepBuilderAPI_MakeEdge_5(L: gp_Lin, p1: number, p2: number) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_5 | - |
| BRepBuilderAPI_MakeEdge_6 | Constructor from line with point bounds | BRepBuilderAPI_MakeEdge_6(L: gp_Lin, P1: gp_Pnt, P2: gp_Pnt) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_6 | - |
| BRepBuilderAPI_MakeEdge_7 | Constructor from line with vertex bounds | BRepBuilderAPI_MakeEdge_7(L: gp_Lin, V1: TopoDS_Vertex, V2: TopoDS_Vertex) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_7 | - |
| BRepBuilderAPI_MakeEdge_8 | Constructor from circle | BRepBuilderAPI_MakeEdge_8(L: gp_Circ) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_8 | - |
| BRepBuilderAPI_MakeEdge_9 | Constructor from circle with parameter bounds | BRepBuilderAPI_MakeEdge_9(L: gp_Circ, p1: number, p2: number) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_9 | - |
| BRepBuilderAPI_MakeEdge_10 | Constructor from circle with point bounds | BRepBuilderAPI_MakeEdge_10(L: gp_Circ, P1: gp_Pnt, P2: gp_Pnt) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_10 | - |
| BRepBuilderAPI_MakeEdge_24 | Constructor from 3D geometric curve handle | BRepBuilderAPI_MakeEdge_24(L: Handle_Geom_Curve) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_24 | - |
| BRepBuilderAPI_MakeEdge_25 | Constructor from 3D curve with parameter bounds | BRepBuilderAPI_MakeEdge_25(L: Handle_Geom_Curve, p1: number, p2: number) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_25 | - |
| BRepBuilderAPI_MakeEdge_26 | Constructor from 3D curve with point bounds | BRepBuilderAPI_MakeEdge_26(L: Handle_Geom_Curve, P1: gp_Pnt, P2: gp_Pnt) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_26 | - |
| BRepBuilderAPI_MakeEdge_27 | Constructor from 3D curve with vertex bounds | BRepBuilderAPI_MakeEdge_27(L: Handle_Geom_Curve, V1: TopoDS_Vertex, V2: TopoDS_Vertex) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_27 | - |
| BRepBuilderAPI_MakeEdge_28 | Constructor from 3D curve with vertex and parameter bounds | BRepBuilderAPI_MakeEdge_28(L: Handle_Geom_Curve, V1: TopoDS_Vertex, V2: TopoDS_Vertex, p1: number, p2: number) | https://ocjs.org/reference-docs/classes/BRepBuilderAPI_MakeEdge_28 | - |
