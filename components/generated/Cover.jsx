  ...
  return (
    ...
    >
      <CardContent className="p-6">
        ...
        <p className="text-sm">Beautifully designed components 
built with RadixUI and Tailwind CSS</p>
        </div>
        <div className="mb-4">
        <div className="mb-4">
        <div className="mb-2 p-2 border border-gray-200 rounded text-xs text-gray-500">
          INSTANCE: radio group
        </div>
        <div className="mb-2 p-2 border border-gray-200 rounded text-xs text-gray-500">
          INSTANCE: popover
        </div>
        ...
        <div className="mb-4">
        <p className="text-sm">This figma file was made with love by @skirano</p>
        <div className="mb-4">
        <div className="mb-2 p-2 border border-gray-200 rounded text-xs text-gray-500">
          INSTANCE: tooltip
        </div>
